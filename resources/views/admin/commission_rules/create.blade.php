...
@section('title', 'Tambah Aturan Komisi')
@section('content')
    <form method="POST" action="{{ route('admin.commission_rules.store') }}" class="bg-white border border-slate-200 rounded-xl p-6 space-y-4">
        @csrf
